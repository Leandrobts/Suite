...
import { logS1, PAUSE_S1, toHexS1, isPotentialPointer64S1, isPotentialData32S1 } from './s1_utils.mjs';
...
export async function testOOBReadInfoLeakEnhancedStoreS1() {
    ...
    setLeakedValueS1(null); // Reset state
    ...
    try {
        ...
        for (const readOffset of oobReadOffsets) {
            ...
            if (readTargetAddress >= 0 && readTargetAddress + 8 <= buffer.byteLength) {
                ...
                } catch (e) {/*ignore read errors out of bounds for this test logic*/ }
            }
        ...
        const leakStatus = currentLeakedValue ? `1 valor ${currentLeakedValue.type} @${currentLeakedValue.offset}` : 'nenhum valor armazenado';
